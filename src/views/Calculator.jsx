...
const Calculator = () => {
  ...
  const calculatedPrice =
    parseFloat(cost1) && parseFloat(targetMargin)
      ? parseFloat(cost1) / (1 - parseFloat(targetMargin) / 100)
      : 0;

  // Margen = ((Precio Venta - Costo) / Precio Venta) * 100
  const calculatedMargin =
    parseFloat(cost2) && parseFloat(sellPrice) && parseFloat(sellPrice) > 0
      ? ((parseFloat(sellPrice) - parseFloat(cost2)) / parseFloat(sellPrice)) *
        100
      : 0;

  const calculatedProfit2 =
    ...
    <div>
      ...
      >
        <p style={{ color: "var(--text-muted)" }}>
          Usa la fórmula comercial correcta para calcular tus precios. Recuerda
          que el margen se calcula sobre el precio de venta final, no sobre el
          costo.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "2rem", flex: 1 }}>
            ...
            >
              Si conoces tu costo y sabes qué porcentaje de margen quieres
              ganar, averigua a qué precio debes vender.
            </p>
                ...
                >
                  <div>
                    ...
                    <span style={{ fontWeight: "bold" }}>
                      {formatCLP(calculatedPrice - parseFloat(cost1))}
                    </span>
                  </div>
                </div>
              )}
        ...
        >
          ...
          <div style={{ padding: "2rem", flex: 1 }}>
            ...
            >
              Si ya tienes un costo y un precio de venta definido, averigua cuál
              es tu porcentaje de margen real.
            </p>
            ...
            >
              ...
              <h3
                style={{
                  fontSize: "2.5rem",
                  color: calculatedMargin > 0 ? "#10B981" : "var(--danger)",
                  marginBottom: "0.5rem",
                }}
              >
        ...
        >
          ...
          >
            ...
            <h2 style={{ fontSize: "1.25rem" }}>
              Simulador de Descuentos (Ventas por Mayor)
            </h2>
          </div>
          ...
          >
            <div style={{ flex: "1 1 400px" }}>
              ...
              >
                Evalúa cuánto puedes descontarle a un cliente que compra por
                volumen, viendo inmediatamente cómo afecta tu ganancia y tu
                margen real.
              </p>
            ...
            >
              ...
              <div style={{ marginBottom: "1.5rem" }}>
                ...
                >
                  Precio Total a Cobrar (Con Dscto):
                </p>
                <h3 style={{ fontSize: "2.5rem", color: "#f59e0b", margin: 0 }}>
                  {formatCLP(wTotalPrice)}
                </h3>
                {wDiscountAmount > 0 && (
                  <p
                    style={{
                ...
                <div>
                  ...
                  <span
                    style={{
                      fontWeight: "bold",
                      fontSize: "1.1rem",
                      color: wFinalMargin > 0 ? "#10B981" : "var(--danger)",
                    }}
                  >
                ...
                <div>
                  ...
                  <span
                    style={{
                      fontWeight: "bold",
                      fontSize: "1.1rem",
                      color: wProfit >= 0 ? "#10B981" : "var(--danger)",
                    }}
                  >
                    {formatCLP(wProfit)}
                  </span>
