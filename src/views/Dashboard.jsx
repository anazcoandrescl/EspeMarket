...
const Dashboard = ({ products, baskets, sales }) => {
  ...
  const salesToday = sales.filter(
    (s) => new Date(s.date).toLocaleDateString("es-CL") === today,
  );
  ...
  const cashToday = salesToday
    .filter((s) => s.paymentMethod === "Efectivo")
    .reduce((acc, s) => acc + (Number(s.revenue) || 0), 0);
  const transferToday = salesToday
    ...
    <div>
      <div className="header" style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Métricas clave y estado general del negocio al día de hoy ({today}).
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          >
            {salesToday.length} transacciones
          </p>
        </div>
      ...
      >
        ...
        <div className="glass-panel" style={{ padding: "1.5rem" }}>
          ...
          {lowStockItems.length === 0 ? (
            ...
            >
              Todo el inventario está sano. Ningún artículo bajo stock crítico
              (≤ 5).
            </p>
          ) : (
            <ul
        ...
        <div className="glass-panel" style={{ padding: "1.5rem" }}>
          ...
          {topProducts.length === 0 ? (
            ...
            >
              Aún no hay suficientes datos de ventas para mostrar estrellas.
            </p>
          ) : (
            <ul
              style={{
