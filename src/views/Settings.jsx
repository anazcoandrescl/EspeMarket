...
const Settings = ({
  ...
  const createBackup = () => {
    ...
    downloadAnchorNode.setAttribute(
      "download",
      `Respaldo_EspeMarket_${new Date().toISOString().split("T")[0]}.json`,
    );
  ...
  const restoreBackup = (e) => {
    ...
    reader.onload = (evt) => {
      try {
        ...
        if (
          window.confirm(
            "¿Estás seguro de cargar este respaldo? Se sobrescribirán todos los datos actuales.",
          )
        ) {
    ...
    <div>
      ...
      >
        ...
        <div className="glass-panel" style={{ padding: "2rem" }}>
          ...
          >
            Estos datos aparecerán en los PDFs de las cotizaciones que envíes a
            tus clientes.
          </p>
        ...
        >
          ...
          >
            Protege tu información. Descarga un archivo con todos tus productos,
            canastas y configuración para que nunca pierdas tu trabajo.
          </p>
          ...
          >
            ...
            >
              ...
              >
                Descarga una copia de seguridad a tu computador.
              </p>
              <button
            ...
            >
              ...
              >
                Sube un archivo de respaldo previo. ¡Cuidado, reemplazará lo
                actual!
              </p>
              <input
                type="file"
        ...
        >
          ...
          >
            Personaliza las categorías de tus productos y asígnales un color
            único.
          </p>
