...
const LiveDashboard = ({ products, baskets, sales = [] }) => {
  ...
  const peakHour = hourlyData.reduce(
    (best, h) => (h.Ingresos > (best?.Ingresos || 0) ? h : best),
    null,
  );
    ...
    <div>
      <div className="header" style={{ marginBottom: "1.5rem" }}>
        <div>
          ...
          <p style={{ color: "var(--text-muted)", marginTop: "0.5rem" }}>
            Monitoreo de flujo de caja y ventas en tiempo real.
          </p>
        </div>
      </div>
      ...
      >
        <div
          ...
          style={{ padding: "1.5rem", borderBottom: "4px solid #60a5fa" }}
        >
          <p
            style={{
          ...
          <h3 style={{ fontSize: "2rem", margin: "0.5rem 0" }}>
            {formatCLP(revenueToday)}
          </h3>
          <p style={{ fontSize: "0.85rem", color: "#60a5fa" }}>
            {salesToday.length} pedidos hoy
          </p>
        </div>

        <div
          className="glass-panel"
          style={{ padding: "1.5rem", borderBottom: "4px solid #10B981" }}
        >
          <p
            style={{
              color: "var(--text-muted)",
          ...
          <h3
            style={{ fontSize: "2rem", margin: "0.5rem 0", color: "#10B981" }}
          >
            {formatCLP(profitMonth)}
          </h3>
        ...
        <div
          className="glass-panel"
          style={{ padding: "1.5rem", borderBottom: "4px solid #f59e0b" }}
        >
          <p
            style={{
              color: "var(--text-muted)",
      ...
      >
        <div className="glass-panel" style={{ padding: "1.5rem" }}>
          ...
          >
            <Activity size={18} color="var(--primary)" /> Tendencia (Últimos 7
            días)
          </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      >
                        Ganancia: {formatCLP(Number(s.profit) || 0)}
                      </p>
                    </div>
                  </div>
                );
      ...
      >
        ...
        >
          ...
          >
            <Clock size={20} color="var(--primary)" /> Ventas por Hora del Día
            (Hoy)
          </h2>
          {peakHour && peakHour.Ventas > 0 && (
            ...
            >
              ⚡ Hora pico: <strong>{peakHour.hour}</strong> —{" "}
              {formatCLP(peakHour.Ingresos)}
            </div>
          )}
        </div>
        {salesToday.length === 0 ? (
